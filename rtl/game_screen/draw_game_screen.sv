...
*
* Description: draw_game_screen module - displays a scaled game screen image from ROM
*/
module draw_game_screen #(
    ...
    // Pipeline 1 - calculate ROM address with scaling
